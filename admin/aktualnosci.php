...
function edytuj($news, $tabela = "newsy", $tytul, $kto, $email, $tresc, $rok, $miesiac, $miesiac_num, $dzien, $godzina, $dzial, $zdjecie, $zrodlo, $rodzaj, $zawodnik, $zawodnik2, $zawodnik3, $druzyna, $top, $ciekawe, $sezon, $autor) {
   ...
   if(!$news) {
      ...
      echo "<tr><td class=tekst>Zdjęcie ";
      ...
      print "<tr><td>Źródło: <input type=text name=zrodlo value=\"$rekord[zrodlo]\"></td></tr>";
      ...
      echo "<tr><td><input type=radio name=rodzaj value=\"\"$nic>Bez rodzaju <input type=radio name=rodzaj value=\"Artykuł\"$art>Artykuł <input type=radio name=rodzaj value=\"Wywiad\"$wyw>Wywiad <input type=radio name=rodzaj value=\"Zapowiedź\"$zap>Zapowiedź</td></tr>";
...
function dopisz($czy, $akcja, $tytul, $kto, $email, $tresc, $rok, $miesiac, $miesiac_num, $dzien, $godzina, $dzial, $zdjecie, $zrodlo, $rodzaj, $zawodnik, $zawodnik2, $zawodnik3, $druzyna, $top, $ciekawe, $sezon, $autor, $wysw) {
   ...
   if($czy!="tak") {
      ...
      echo "</select>";
      echo "</td></tr>";
      echo "<tr><td class=tekst><b>Źródło</td><td class=tekst><input size=65 type=text name=zrodlo value=\"<a target=_blank href=http://www.adres_serwisu.pl>Nazwa_serwisu</a>\"><br><b>Jeśli jest to informacja własna, usuń wszystko z pola Źródło !!!</td></tr>";
