...
if((!$dzial) && (!$mecz) && (!$news)) {
   ...
   print "<br>";
   print "<a href=http://slask.e-basket.pl/index.php?mecz=1248#galeria> <IMG SRC=http://grafika.slask.e-basket.pl/galeria/prawa.jpg WIDTH=200 HEIGHT=300 BORDER=0></a><BR><font class=male>¦l±sk Wroc³aw - Maroussi Ateny</font><br><br>"; 

print "<a href=http://slask.e-basket.pl/?news=3001><IMG SRC=http://grafika.slask.e-basket.pl/grafika/plan_szlachta.gif WIDTH=200 HEIGHT=309 BORDER=0></a><BR>";
 print "<br>";
   rozg_prawa('46','2005/2006','grafika/liga.gif');
   print "<br>";
   print "<P ALIGN=CENTER>";
   print "<br>";
   rozg_prawa('51','2005/2006','grafika/fibaeuro.gif');
   print "<br>";
   $wh = "glowna";
