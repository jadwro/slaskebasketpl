...
<TABLE bgcolor=#eeeeee WIDTH="200" HEIGHT="150" CELLSPACING="0" CELLPADDING="0" BORDER="1" BORDERCOLOR="#dddddd" RULES="NONE" STYLE="margin-top: -5px; padding-top: 3; padding-bottom: 3; padding-left: 3; padding-right: 3">
<TR><TD VALIGN="TOP" WIDTH="200">
<!-- Nastepny mecz -->
<?
...
?>
   <tr><td align=center colspan=2><br><a class=male href=?news=2928><b>..:: Wiêcej informacji ::..</a></td></tr>
   </table><br>
   </td></tr>
   </table>
   <TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0" STYLE="margin-top: -5px">
...
if((!$dzial) && (!$mecz) && (!$news)) {
   wratislavia('47','2005/2006','grafika/wratislavia.gif');
   print "<br>";
