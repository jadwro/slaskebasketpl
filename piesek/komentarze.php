...
function wyswietl() {
   ...
   echo "<table border=1>";
   echo "<tr><td><b>Autor</b></td><td><b>Autoryzacja</b></td><td><b>Treść</b></td><td><b>TOP</b></td></tr>";
   while ($rekord = mysql_fetch_array($pobierz)) {
      echo "<tr><td>$rekord[kto]</td><td>$rekord[auth]</td><td width=250>$rekord[tresc]</td><td>$rekord[top]</td><td><a href=komentarze.php?akcja=edit&kom=$rekord[id]>Edycja</a> / <a href=komentarze.php?akcja=delete&kom=$rekord[id]>Usunięcie</a></td></tr>";
   }
   echo "</table>";
}
...
function autoryzuj() {
   ...
   if($czy!="tak") {
      $pobierz = mysql_query("select*from komentarze where auth=\"nie\" OR zglos=\"tak\" order by id desc");
      echo "<table border=1>";
      ...
      $query = mysql_query("update komentarze set auth=\"tak\", zglos=\"nie\" where id='$kom'");
